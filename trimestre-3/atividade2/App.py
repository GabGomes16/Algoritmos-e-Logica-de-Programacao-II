...
class Application:
    def __init__(self, master=None):
        ...
        self.container1["background"] = "#c4c9d4"
        self.container1.pack()

        self.container2 = Frame(master)
        self.container2["padx"] = 20
        self.container2["pady"] = 5
        self.container2["background"] = "#c4c9d4"
        self.container2.pack()

        self.container3 = Frame(master)
        self.container3["padx"] = 20
        self.container3["pady"] = 5
        self.container3["background"] = "#c4c9d4"
        self.container3.pack()

        self.container4 = Frame(master)
        self.container4["padx"] = 20
        self.container4["pady"] = 5
        self.container4["background"] = "#c4c9d4"
        self.container4.pack()

        self.container5 = Frame(master)
        self.container5["padx"] = 20
        self.container5["pady"] = 5
        self.container5["background"] = "#c4c9d4"
        self.container5.pack()

        self.container6 = Frame(master)
        self.container6["padx"] = 20
        self.container6["pady"] = 5
        self.container6["background"] = "#c4c9d4"
        self.container6.pack()

        self.container7 = Frame(master)
        self.container7["padx"] = 20
        self.container7["pady"] = 5
        self.container7["background"] = "#c4c9d4"
        self.container7.pack()

        self.container8 = Frame(master)
        self.container8["padx"] = 20
        self.container8["pady"] = 10
        self.container8["background"] = "#c4c9d4"
        self.container8.pack()

        self.container9 = Frame(master)
        self.container9["pady"] = 5
        self.container9["background"] = "#c4c9d4"
        self.container9.pack()

        self.container10 = Frame(master)
        self.container10["padx"] = 20
        self.container10["pady"] = 5
        self.container10["background"] = "#c4c9d4"
        self.container10.pack()

        self.titulo = Label(self.container1, text="Informe os dados :")
        self.titulo["font"] = ("Calibri", "9", "bold")
        self.titulo["bg"] = "#c4c9d4"
        self.titulo.pack ()
        ...
        self.lblmsg["bg"] = "#c4c9d4"
        self.lblmsg.pack()

        self.txtMaisUm = Entry(self.container10)
        self.txtMaisUm["width"] = 15
        self.txtMaisUm["font"] = self.fonte
        self.txtMaisUm.pack(side=LEFT)

        self.bntMaisUm = Button(self.container10, text="  +1  ", font=self.fonte, width=12)
        self.bntMaisUm["command"] = self.MaisUM
        self.bntMaisUm.pack(side=LEFT)
    ...
    def MaisUM(self):
        num = Usuarios()
        if self.txtMaisUm == "1":
            num.numero = int(self.txtMaisUm.get())

        self.txtMaisUm.delete(0, END)
        self.txtMaisUm.insert(INSERT, num.AnotherONE())


root = Tk()
root.title("Dados do usuario")
root.geometry("500x350")
root["background"] = "#c4c9d4"
Application(root)
root.mainloop()