...
class Usuarios(object):
    ...
    def __init__(self, idusuario = 0, nome = "", telefone = "", email = "", usuario = "", senha = "", numero= 0):
        self.info = {}
    ...
    def AnotherONE(self):
        ...
        if num == 1:
            ...
            c.execute("insert into numeros(numbers) values ("+ str(num) +")")

        else:
            c = banco.conexao.cursor()

            c.execute("update numeros set numbers = '" + str(num) + "' where numbers="+ self.numero +"")
